...
class Kohana_Database_PDO extends Database {
	...
	public function connect()
	{
		...
		try
		{
			...
			//print_r("$dsn, $username, $password, $attrs"); die("FUERA");
	...
	/*DAF: For sqlite !!!ORM support!!!!: It must substitute this set_charset, list_table and list_columns original functions for the following versions*/
